					...
					>
						<div className="flex items-center gap-3 mb-4">
							...
							<span className="text-xl font-bold font-mono">
								Friday<span className="text-primary">Claw</span>
							</span>
						</div>
						<p className="text-muted-foreground max-w-md leading-relaxed mb-6">
							Digital menace. Truth teller. Chaos manager. Built to ensure Denny ships, roast bad
							ideas, and execute with precision.
						</p>
